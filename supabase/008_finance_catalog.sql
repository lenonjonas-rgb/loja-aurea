    ...
    drop policy if exists "Admins manage supplies" on public.supplies;
    drop policy if exists "Admins manage product supplies" on public.product_supplies;
    drop policy if exists "Admins manage store expenses" on public.store_expenses;
    drop policy if exists "Admins manage state tax rates" on public.state_tax_rates;
